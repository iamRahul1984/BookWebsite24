...
<?php include '../include/navbar.php'; ?>
    ...
    <div class="container">
        <div class="left-section">
            <img src="../images/grayman/grayman book 6.jpg" alt="Book " class="book-image">
        </div>
        <div class="right-section">
            <div class="book-name" ><h1>Gunmetal Grey (Gray Man #6)</h1>
                <p>BY Mark Greaney</p>
            </div>
            <div class="book-info">
                <h1>Book Information</h1>
                <p><strong>Full Name:</strong>Gunmetal Grey</p>
                <p><strong>Author:</strong> Mark Greaney</p>   
                <p><strong>Published:</strong> February 14, 2017</p>
                <p><strong>Genre:</strong> Action,Thriller,Espionage</p>
                <p><strong>Pages:</strong> 528</p>
                <p><strong>Language:</strong>English</p>
                <p><strong>ISBN:</strong> 9780451489739 </p>
...
<br>
            ...
            <div class="buy-link">
                <h1>Buy From Here </h1>
                <a href="https://www.flipkart.com/gunmetal-gray/p/itmf3zargdzfbhjt?pid=9780451489739&lid=LSTBOK9780451489739EDGDHI&marketplace=FLIPKART&cmpid=content_book_8965229628_gmc">
